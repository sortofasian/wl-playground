...
pub mod xdg_wm_base {
        ...
        unsafe fn from_raw_c(
            ...
            match opcode {
                ...
                1 => {
                    ...
                    Ok(Request::CreatePositioner {
                        id: {
                            let me = Resource::<XdgWmBase>::from_c_ptr(obj as *mut _);
                            me.make_child_for::<super::xdg_positioner::XdgPositioner>(_args[0].n)
                                .unwrap()
                        },
                    })
                }
                2 => {
                    ...
                    Ok(Request::GetXdgSurface {
                        id: {
                            let me = Resource::<XdgWmBase>::from_c_ptr(obj as *mut _);
                            me.make_child_for::<super::xdg_surface::XdgSurface>(_args[0].n)
                                .unwrap()
                        },
    ...
    pub struct XdgWmBase(Resource<XdgWmBase>);
    impl AsRef<Resource<XdgWmBase>> for XdgWmBase {
        #[inline]
        fn as_ref(&self) -> &Resource<Self> {
            &self.0
        }
    }
    impl From<Resource<XdgWmBase>> for XdgWmBase {
        #[inline]
        fn from(value: Resource<Self>) -> Self {
            XdgWmBase(value)
        }
    }
    impl From<XdgWmBase> for Resource<XdgWmBase> {
        #[inline]
...
pub mod xdg_positioner {
        ...
        unsafe fn from_raw_c(
            ...
            match opcode {
                ...
                4 => {
                    let _args = ::std::slice::from_raw_parts(args, 1);
                    Ok(Request::SetGravity {
                        gravity: Gravity::from_raw(_args[0].u).ok_or(())?,
                    })
                }
                5 => {
                    let _args = ::std::slice::from_raw_parts(args, 1);
                    Ok(Request::SetConstraintAdjustment {
                        constraint_adjustment: _args[0].u,
                    })
                }
                6 => {
                    let _args = ::std::slice::from_raw_parts(args, 2);
                ...
                8 => {
                    let _args = ::std::slice::from_raw_parts(args, 2);
                    Ok(Request::SetParentSize {
                        parent_width: _args[0].i,
                        parent_height: _args[1].i,
                    })
                }
                9 => {
                    let _args = ::std::slice::from_raw_parts(args, 1);
                    Ok(Request::SetParentConfigure { serial: _args[0].u })
                }
                _ => return Err(()),
            }
        }
    ...
    #[derive(Clone, Eq, PartialEq)]
    pub struct XdgPositioner(Resource<XdgPositioner>);
    impl AsRef<Resource<XdgPositioner>> for XdgPositioner {
        #[inline]
        fn as_ref(&self) -> &Resource<Self> {
            &self.0
        }
    }
    impl From<Resource<XdgPositioner>> for XdgPositioner {
        #[inline]
        fn from(value: Resource<Self>) -> Self {
            XdgPositioner(value)
        }
    }
    impl From<XdgPositioner> for Resource<XdgPositioner> {
        #[inline]
...
pub mod xdg_surface {
        ...
        unsafe fn from_raw_c(
            ...
            match opcode {
                ...
                1 => {
                    ...
                    Ok(Request::GetToplevel {
                        id: {
                            let me = Resource::<XdgSurface>::from_c_ptr(obj as *mut _);
                            me.make_child_for::<super::xdg_toplevel::XdgToplevel>(_args[0].n)
                                .unwrap()
                        },
                    })
                }
                2 => {
                    ...
                    Ok(Request::GetPopup {
                        id: {
                            let me = Resource::<XdgSurface>::from_c_ptr(obj as *mut _);
                            me.make_child_for::<super::xdg_popup::XdgPopup>(_args[0].n)
                                .unwrap()
                        },
                        parent: if _args[1].o.is_null() {
                            None
                        } else {
                            Some(
                                Resource::<super::xdg_surface::XdgSurface>::from_c_ptr(
                                    _args[1].o as *mut _,
                                )
                                .into(),
                            )
                        },
                        positioner: Resource::<super::xdg_positioner::XdgPositioner>::from_c_ptr(
                            _args[2].o as *mut _,
                        )
                        .into(),
                    })
    ...
    impl super::MessageGroup for Event {
        ...
        fn into_raw(self, sender_id: u32) -> Message {
            match self {
                Event::Configure { serial } => Message {
                    sender_id: sender_id,
                    opcode: 0,
                    args: smallvec![Argument::Uint(serial),],
                },
    ...
    #[derive(Clone, Eq, PartialEq)]
    pub struct XdgSurface(Resource<XdgSurface>);
    impl AsRef<Resource<XdgSurface>> for XdgSurface {
        #[inline]
        fn as_ref(&self) -> &Resource<Self> {
            &self.0
        }
    }
    impl From<Resource<XdgSurface>> for XdgSurface {
        #[inline]
        fn from(value: Resource<Self>) -> Self {
            XdgSurface(value)
        }
    }
    impl From<XdgSurface> for Resource<XdgSurface> {
        #[inline]
    ...
    impl XdgSurface {
        ...
        pub fn configure(&self, serial: u32) -> () {
            let msg = Event::Configure { serial: serial };
            self.0.send(msg);
        }
    }
    #[doc = r" The minimal object version supporting this request"]
...
pub mod xdg_toplevel {
                ...
                1 => {
                    ...
                    Ok(Request::SetParent {
                        parent: if _args[0].o.is_null() {
                            ...
                            Some(
                                Resource::<super::xdg_toplevel::XdgToplevel>::from_c_ptr(
                                    _args[0].o as *mut _,
                                )
                                .into(),
                            )
                ...
                6 => {
                    ...
                    Ok(Request::Resize {
                        seat: Resource::<super::wl_seat::WlSeat>::from_c_ptr(_args[0].o as *mut _)
                            .into(),
                        serial: _args[1].u,
                        edges: ResizeEdge::from_raw(_args[2].u).ok_or(())?,
                    })
                }
                7 => {
                    let _args = ::std::slice::from_raw_parts(args, 2);
            ...
            F: FnOnce(u32, &mut [wl_argument]) -> T,
        {
            match self {
                Event::Configure {
                    ...
                    let _arg_2 = wl_array {
                        size: states.len(),
                        alloc: states.capacity(),
                        data: states.as_ptr() as *mut _,
                    };
    ...
    #[derive(Clone, Eq, PartialEq)]
    pub struct XdgToplevel(Resource<XdgToplevel>);
...
pub mod xdg_popup {
    ...
    impl super::MessageGroup for Event {
        ...
        fn into_raw(self, sender_id: u32) -> Message {
            match self {
                ...
                Event::Repositioned { token } => Message {
                    sender_id: sender_id,
                    opcode: 2,
                    args: smallvec![Argument::Uint(token),],
                },
            }
        }
        unsafe fn from_raw_c(
    ...
    #[derive(Clone, Eq, PartialEq)]
    pub struct XdgPopup(Resource<XdgPopup>);
    ...
    impl XdgPopup {
        ...
        pub fn repositioned(&self, token: u32) -> () {
            let msg = Event::Repositioned { token: token };
            self.0.send(msg);
        }
    }
    #[doc = r" The minimal object version supporting this request"]
